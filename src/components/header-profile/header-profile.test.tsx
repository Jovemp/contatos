...
import { ListagemContext } from "../../contexts/listagem";

const defaultValue = {
  updateStar: (name: string, shortName: string) => {},
  listContatos: [],
  updateFiltro: (value: string) => {},
  sortName: () => {},
  sortDate: () => {},
  contatoSelecionado: {
    star: false,
  ...
  selecionaContato: (shortName: string) => {},
};

const renderComponent = (value = defaultValue) =>
  render(
    <ListagemContext.Provider value={value}>
      <HeaderProfile />
